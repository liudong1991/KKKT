...
/**
 * RSA算法简单实现
 * Date : 2015年9月22日 下午6:59:57
 *
 * @author steve@shanshuirong.com<br>
 * Copyright (c) 2015, shanshuirong.com All Rights Reserved.
 */
public class RSAUtil {
    ...
    public static String getRSA(String value) {
        Log.i(RSAUtil.class.getName(), "wust==>rsa input:" + value);
        value = Md5Util.md5Util(value);
        String pwdn = "";
        try {
            pwdn = RSAUtil.encrypt(value, Constants.OPENAPI_SECURITY_KEY);
        } catch (Exception e) {
            e.printStackTrace();
        }
        return pwdn;
