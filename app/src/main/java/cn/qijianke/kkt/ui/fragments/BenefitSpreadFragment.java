...
public class BenefitSpreadFragment extends BaseFragment {
    ...
    private void loadList(int page) {
        ...
        RequestWrapper.getSpreadProfit(param);
    }

    @Subscribe(threadMode = ThreadMode.MAIN)
    public void receiveLoadListResult(SpreadProfitWrapper spreadProfitWrapper) {
        List<ProfitResp> profitRespList = spreadProfitWrapper.getList();
    ...
    private BaseAdapter adapter = new BaseAdapter() {
        ...
        public View getView(int i, View view, ViewGroup viewGroup) {
            ...
            if (view == null) {
                ...
                vh.mobile = view.findViewById(R.id.mobile);
                view.setTag(vh);
            } else {
                vh = (ViewHolder) view.getTag();
            }
            vh.date_tv.setText(getItem(i).getRecommendTime());
            vh.benefit_tv.setText(String.format("%1$.2f元", getItem(i).getProfitAmt() / 100d));
            vh.mobile.setText(getItem(i).getRecommendMobileNum());
            return view;
        }
