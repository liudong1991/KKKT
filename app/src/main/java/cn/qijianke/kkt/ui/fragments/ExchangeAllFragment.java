...
public class ExchangeAllFragment extends BaseFragment {
    ...
    public void receiveLoadListResult(SearchExchangeRespWrapper searchExchangeRespWrapper) {
        if (!"1".equals(searchExchangeRespWrapper.getTag())) {
            return;
        }
    ...
    private BaseAdapter adapter = new BaseAdapter() {
        ...
        public View getView(int i, View view, ViewGroup viewGroup) {
            ...
            vh.status_tv.setTextColor("APPR".equals(status) ? Color.GREEN : Color.parseColor("#FF6C6C"));
            vh.remark_tv.setVisibility("REJT".equals(status) ? View.VISIBLE : View.GONE);
            vh.remark_tv.setText(getItem(i).getRemark());
            vh.opinion_tv.setVisibility("REJT".equals(status) ? View.VISIBLE : View.GONE);
