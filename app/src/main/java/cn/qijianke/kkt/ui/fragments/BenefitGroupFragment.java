...
public class BenefitGroupFragment extends BaseFragment {
    ...
    private void loadList(int page) {
        ...
        RequestWrapper.getTeamProfit(param);
    }

    @Subscribe(threadMode = ThreadMode.MAIN)
    public void receiveLoadListResult(TeamProfitWrapper teamProfitWrapper) {
        List<ProfitResp> profitRespList = teamProfitWrapper.getList();
