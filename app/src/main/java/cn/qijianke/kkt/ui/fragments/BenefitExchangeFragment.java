...
import cn.qijianke.kkt.model.resp.LoadProfitExchangeResp;
...
public class BenefitExchangeFragment extends BaseFragment {
    ...
    List<LoadProfitExchangeResp> list = new ArrayList<>();
    ...
    private void loadList(int page) {
        LoadProfitExchangeParam param = new LoadProfitExchangeParam();
        ...
        RequestWrapper.loadProfitExchange(param);
    }

    @Subscribe(threadMode = ThreadMode.MAIN)
    public void receiveLoadListResult(LoadProfitExchangeRespWrapper benefitDetailRespWrapper) {
        List<LoadProfitExchangeResp> benefitDetailRespList = benefitDetailRespWrapper.getList();
        handler.loadSuccess(list, benefitDetailRespList);
    ...
    private BaseAdapter adapter = new BaseAdapter() {
        ...
        @Override
        public LoadProfitExchangeResp getItem(int i) {
            return list.get(i);
        }
        ...
        public View getView(int i, View view, ViewGroup viewGroup) {
            ...
            vh.benefit_tv.setText(String.format("%1$.2f元", getItem(i).getAmount() / 100));
